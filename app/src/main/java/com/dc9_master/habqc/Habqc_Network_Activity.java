 ...
 */
public class Habqc_Network_Activity extends Activity {

    Integer count_subareathree;
    Button next_btn;
    Spinner spinner_geographic, spinner_subarea_one, spinner_subarea_two, spinner_subarea_three,spinner_inspection;
    ...
    ArrayList<String> inspection_name_list;

    ArrayAdapter<String> geographic_adapter,subareaone_adapter,subareatwo_adapter,subareathree_adapter,inspection_adapter;
    ...
    Cursor geographic_cursor,subareaone_cursor,subareatwo_cursor,subareathree_cursor,inspection_cursor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.habitation_qc_network);


        sessionManager = new SessionManager(Habqc_Network_Activity.this);
        ...
        spinner_inspection=findViewById(R.id.inspection_id);
        ...
        inspection_name_list=new ArrayList<String>();


        new Geographic_Value(Habqc_Network_Activity.this).execute();
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaOne_Value(Habqc_Network_Activity.this).execute();
                } else {
        ...
        spinner_subarea_one.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
               ...
               //  Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                  if (position > 0) {
                    new SubAreaTwo_Value(Habqc_Network_Activity.this).execute();
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaThree_Value(Habqc_Network_Activity.this).execute();
        ...
        new Inspection_Value(Habqc_Network_Activity.this).execute();
        spinner_inspection.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view,
                                       int position, long id) {
                // TODO Auto-generated method stub
                inspection_id = inspection_name_list.get(position).toString();
                }
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               str_inspectionid  = spinner_inspection.getSelectedItem().toString();
                ...
                if (spinner_geographic.getSelectedItemPosition() == 0 ||
                        ...
                        spinner_subarea_three.getSelectedItemPosition() == 0 || spinner_inspection.getSelectedItemPosition()==0) {

                    final Dialog dialog = new Dialog(Habqc_Network_Activity.this);
                ...
                else
                    {
                        ...
                        DataHolder_workprogress.getInstance().setStr_network_inspection(inspection_id);
                       ...
                       // startActivity(new Intent(Site_Inspection_Activity.this, Site_Inspection_Item.class));
                        startActivity(new Intent(Habqc_Network_Activity.this, Habqc_Network_Item_Activity.class));
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Habqc_Network_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Habqc_Network_Activity.this);
            try {
    ...
    //------------------------ Inspection --------------------------------------//
    public class Inspection_Value extends AsyncTask<String, String, String> {
        ProgressDialog pd;Context _context;
        Inspection_Value(Context ctx) {_context=ctx;}
        @Override
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                sqLiteAdapter.openToRead();
                sqLiteAdapter.openToWrite();
                if(inspection_cursor!=null){
                    inspection_cursor=null;
                }

                inspection_cursor = sqLiteAdapter.select_infra_all();
                inspection_name_list.clear();
                if(inspection_cursor!=null && inspection_cursor.moveToFirst()){
                    inspection_name_list.add("Select Inspection");

                    do {
                        String inspection_name=inspection_cursor.getString(1);
                        inspection_name_list.add(inspection_name);
                    } while (inspection_cursor.moveToNext());
                }
            }catch (Exception e){
                e.printStackTrace();
                // Log.e("exception",e.getMessage());
        ...
        protected void onPostExecute(String result) {
            ...
            pd.dismiss();
            try {
                inspection_adapter = new ArrayAdapter<String>(
                            getApplicationContext(), R.layout.custom_spinner, R.id.textView1, inspection_name_list);
                    spinner_inspection.setAdapter(inspection_adapter);
                    sqLiteAdapter.close();
