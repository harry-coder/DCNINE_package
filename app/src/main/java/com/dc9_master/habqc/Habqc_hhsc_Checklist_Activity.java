 ...
 */
public class Habqc_hhsc_Checklist_Activity extends Activity {
    private static Habqc_hhsc_Checklist_Activity sActivity;

    public static Habqc_hhsc_Checklist_Activity getsActivity(){return sActivity;}
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // tv_text.setText(DataHolder_workprogress.getInstance().getItem_name());
        ...
        //-------------for Pole Activity------------------//
        new Item_Value(Habqc_hhsc_Checklist_Activity.this).execute();
        sessionManager = new SessionManager(Habqc_hhsc_Checklist_Activity.this);
        ...
        remark_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Habqc_hhsc_Checklist_Activity.this, SiteInspectionRemark_Activity.class);
                startActivity(i);
        ...
        camera_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(Habqc_hhsc_Checklist_Activity.this, Camera_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
...
//                        op=DataHolder_SiteInspection.getInstance().getSelectedStrings();
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone()) ||
                    ...
                    final Dialog dialog = new Dialog(Habqc_hhsc_Checklist_Activity.this);
                    dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                   ...
                   // Intent i = new Intent(SiteInspectionChecklist_Activity.this, SiteInspectionUpload.class);
                    Intent i = new Intent(Habqc_hhsc_Checklist_Activity.this, Habqc_HHSC_Pass_Activity.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                }
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Habqc_hhsc_Checklist_Activity.this);
    ...
    public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(Habqc_hhsc_Checklist_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Habqc_hhsc_Checklist_Activity.this);
            try {
                ...
                item_cursor=sqLiteAdapter.select_sor_item_parameter_all(Integer.parseInt("6"));
               // item_cursor=sqLiteAdapter.select_ncr_all();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
               ...
               /* final AreaDataAdapter adapter= new AreaDataAdapter(getApplicationContext(), item_name_list,item_code_list);
                ...
                final AreaDataSIAdapter adapter= new AreaDataSIAdapter(Habqc_hhsc_Checklist_Activity.this, item_name_list,item_code_list);
                listView.setAdapter(adapter);
