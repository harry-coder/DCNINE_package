 ...
 */
public class Habqc_Network_Pass_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.habqc_network_passrework2);
        ...
        sqLiteAdapterw= new SQLiteAdapterWorkprogress(this);
        ...
        alert_pass_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DataHolder_workprogress.getInstance().setNetwork_pass_rework_status("Pass");
                alert_pop.setVisibility(View.GONE);
            }
        });
        alert_rework_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DataHolder_workprogress.getInstance().setNetwork_pass_rework_status("Rework");
                alert_pop.setVisibility(View.GONE);
            }
        });
        ...
        next_item_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone())|| TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareatwo())|| TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareathree())) {
                    ...
                    final Dialog dialog = new Dialog(Habqc_Network_Pass_Activity.this);
                ...
                else
                {
                    ...
                    sqLiteAdapterw.insert_valueNETWORK(sessionManager.GET_EMP_ID(),
                    ...
                    dialogButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            startActivity(new Intent(Habqc_Network_Pass_Activity.this, Habqc_Network_Item_Activity.class));
               ...
               /* Intent i = new Intent(Habqc_Network_Pass_Activity.this, Habqc_Network_Item_Activity.class);
                startActivity(i);
        ...
        btn_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone())|| TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareatwo())|| TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareathree())) {
                    ...
                    Intent i = new Intent(Habqc_Network_Pass_Activity.this, NetworkUpload.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                }
            }
