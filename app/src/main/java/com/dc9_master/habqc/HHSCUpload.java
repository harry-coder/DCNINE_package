...
public class HHSCUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(HHSCUpload.this);
        sessionManager =new SessionManager(HHSCUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(HHSCUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(HHSCUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(HHSCUpload.this);
                    ...
                    sqLiteAdapter.insert_valueHHSC(sessionManager.GET_EMP_ID(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(HHSCUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("meter_no", DataHolder_workprogress.getInstance().getMeter_no()));
                    ...
                    Log.e("name value hhsc", "" + nameValuePairs);
