 ...
 */
public class SiteInspectionChecklist_Activity extends Activity {
    private static SiteInspectionChecklist_Activity sActivity;

    public static SiteInspectionChecklist_Activity getsActivity(){return sActivity;}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.siteinspection_checkbox);
        ...
        //-------------for Pole Activity------------------//
        new Item_Value(SiteInspectionChecklist_Activity.this).execute();
        sessionManager = new SessionManager(SiteInspectionChecklist_Activity.this);
        ...
        remark_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SiteInspectionChecklist_Activity.this, SiteInspectionRemark_Activity.class);
                startActivity(i);
        ...
        camera_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(SiteInspectionChecklist_Activity.this, Camera_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
...
//                        op=DataHolder_SiteInspection.getInstance().getSelectedStrings();
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone()) ||
                    ...
                    final Dialog dialog = new Dialog(SiteInspectionChecklist_Activity.this);
                    dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                   ...
                   // Intent i = new Intent(SiteInspectionChecklist_Activity.this, SiteInspectionUpload.class);
                    Intent i = new Intent(SiteInspectionChecklist_Activity.this, Site_Inspection_PassRework.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                }
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(SiteInspectionChecklist_Activity.this);
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                   /* latt = 0;
                                    longg = 0;
                                    */
                                    startActivity(new Intent(SiteInspectionChecklist_Activity.this, CameraMultiPicAll_Activity.class));
                                    // finish();
                                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                                    dialog.cancel();
                                }
    ...
    public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(SiteInspectionChecklist_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(SiteInspectionChecklist_Activity.this);
            try {
                ...
                //item_cursor=sqLiteAdapter.select_chooseitem_all(Integer.parseInt(DataHolder_workprogress.getInstance().getItem_id()));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
               ...
               /* final AreaDataAdapter adapter= new AreaDataAdapter(getApplicationContext(), item_name_list,item_code_list);
                ...
                final AreaDataSIAdapter adapter= new AreaDataSIAdapter(SiteInspectionChecklist_Activity.this, item_name_list,item_code_list);
                listView.setAdapter(adapter);
