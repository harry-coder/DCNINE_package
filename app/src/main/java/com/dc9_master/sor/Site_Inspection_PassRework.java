 ...
 */
public class Site_Inspection_PassRework extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.site_inspection_passrework2);
        ...
        connectionDetector=new ConnectionDetector(Site_Inspection_PassRework.this);
        sqLiteAdapterw= new SQLiteAdapterWorkprogress(Site_Inspection_PassRework.this);
        ...
        btn_pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert_text.setText("Are you sure this is a Minor issue?");
        ...
        btn_rework.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert_pop.setVisibility(View.VISIBLE);
                alert_text.setText("Are you sure this is a Major issue ?");
        ...
        alert_pass_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DataHolder_workprogress.getInstance().setHhsc_pass_rework_status("Minor");
                alert_pop.setVisibility(View.GONE);
            }
        });
        alert_rework_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DataHolder_workprogress.getInstance().setHhsc_pass_rework_status("Major");
                alert_pop.setVisibility(View.GONE);
            }
        });
        ...
        btn_camera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Site_Inspection_PassRework.this, CameraLast_Activity.class);
                startActivity(i);
        ...
        btn_next_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone()) ||
                        ...
                        TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareathree()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getHhsc_pass_rework_status())) {

                    final Dialog dialog = new Dialog(Site_Inspection_PassRework.this);
                ...
                else
                {
                    ...
                    sqLiteAdapterw.insert_value(sessionManager.GET_EMP_ID(),
                    ...
                    dialogButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            startActivity(new Intent(Site_Inspection_PassRework.this, SiteInspection_Item_Activity.class));
                            }
                    });
                    dialog.show();
                   ...
                   */
                    ...
                    /*Intent i = new Intent(Site_Inspection_PassRework.this, SiteInspection_Item_Activity.class);
                      startActivity(i);
                      overridePendingTransition(R.anim.right_in, R.anim.left_out);*/
             }
         });
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone()) ||
                    ...
                    Intent i = new Intent(Site_Inspection_PassRework.this, SiteInspectionUpload.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                }
            }
