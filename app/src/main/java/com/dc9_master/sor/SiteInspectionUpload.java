...
public class SiteInspectionUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(SiteInspectionUpload.this);
        sessionManager =new SessionManager(SiteInspectionUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(SiteInspectionUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(SiteInspectionUpload.this);
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(SiteInspectionUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("imgname3", DataHolder_workprogress.getInstance().getImageNmae3()));
                    ...
                    nameValuePairs.add(new BasicNameValuePair("img3", DataHolder_workprogress.getInstance().getImg3()));
                    nameValuePairs.add(new BasicNameValuePair("auto_number", DataHolder_workprogress.getInstance().getAuto_number()));
                    nameValuePairs.add(new BasicNameValuePair("pass_rework_status", DataHolder_workprogress.getInstance().getHhsc_pass_rework_status()));
                    nameValuePairs.add(new BasicNameValuePair("landmark", DataHolder_workprogress.getInstance().getStr_landmark()));

                    httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
                    Log.e("name value sor", "" + nameValuePairs);
