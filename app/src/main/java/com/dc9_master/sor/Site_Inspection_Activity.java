 ...
 */
public class Site_Inspection_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(Site_Inspection_Activity.this);
        ...
        ed_landmark = (EditText) findViewById(R.id.ed_nearest);
        ...
        new Geographic_Value(Site_Inspection_Activity.this).execute();
        spinner_geographic.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //   Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                if (position > 0) {
                    new SubAreaOne_Value(Site_Inspection_Activity.this).execute();
                } else {
        ...
        spinner_subarea_one.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                //  Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                  if (position > 0) {
                    new SubAreaTwo_Value(Site_Inspection_Activity.this).execute();
                    } else {
                    spinner_subarea_two.setVisibility(View.GONE);
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaThree_Value(Site_Inspection_Activity.this).execute();
                    } else {
                    spinner_subarea_three.setVisibility(View.GONE);
                    //spinner_subarea_three.setAdapter(null);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinner_geographic.getSelectedItemPosition() == 0 ||
                    ...
                    final Dialog dialog = new Dialog(Site_Inspection_Activity.this);
                ...
                else
                    {
                        ...
                        startActivity(new Intent(Site_Inspection_Activity.this, SiteInspection_Item_Activity.class));
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Site_Inspection_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Site_Inspection_Activity.this);
            try {
