...
public class PoleUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(PoleUpload.this);
        sessionManager =new SessionManager(PoleUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(PoleUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(PoleUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(PoleUpload.this);
                    ...
                    sqLiteAdapter.insert_valuePOLE(sessionManager.GET_EMP_ID(),
                            ...
                            DataHolder_workprogress.getInstance().getStr_vendorName(),
                            DataHolder_workprogress.getInstance().getStr_landmark(),
                            DataHolder_workprogress.getInstance().getItem_id(),
                            DataHolder_workprogress.getInstance().getStr_po_no(),
                            DataHolder_workprogress.getInstance().getStr_di_no(),
                            ...
                            DataHolder_workprogress.getInstance().getImageNmae4(),
                            DataHolder_workprogress.getInstance().getImageNmae5(),
                            ...
                            DataHolder_workprogress.getInstance().getImg4(),
                            DataHolder_workprogress.getInstance().getImg5(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(PoleUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("landmark", DataHolder_workprogress.getInstance().getStr_landmark()));
                    ...
                    nameValuePairs.add(new BasicNameValuePair("recevQty", DataHolder_workprogress.getInstance().getStrRecvQty()));
                    ...
                    nameValuePairs.add(new BasicNameValuePair("imgname_challan", DataHolder_workprogress.getInstance().getImageNmae1()));
                    nameValuePairs.add(new BasicNameValuePair("imgname_lr", DataHolder_workprogress.getInstance().getImageNmae2()));
                    nameValuePairs.add(new BasicNameValuePair("imgname_invoice", DataHolder_workprogress.getInstance().getImageNmae3()));
                    nameValuePairs.add(new BasicNameValuePair("imgname_packing", DataHolder_workprogress.getInstance().getImageNmae4()));
                    nameValuePairs.add(new BasicNameValuePair("imgname_waybill", DataHolder_workprogress.getInstance().getImageNmae5()));
                    nameValuePairs.add(new BasicNameValuePair("img_challan", DataHolder_workprogress.getInstance().getImg1()));
                    nameValuePairs.add(new BasicNameValuePair("img_lr", DataHolder_workprogress.getInstance().getImg2()));
                    nameValuePairs.add(new BasicNameValuePair("img_invoice", DataHolder_workprogress.getInstance().getImg3()));
                    nameValuePairs.add(new BasicNameValuePair("img_packing", DataHolder_workprogress.getInstance().getImg4()));
                    nameValuePairs.add(new BasicNameValuePair("img_waybill", DataHolder_workprogress.getInstance().getImg5()));
                    nameValuePairs.add(new BasicNameValuePair("auto_number", DataHolder_workprogress.getInstance().getAuto_number()));

                    httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
                    Log.e("name value pole", "" + nameValuePairs);
