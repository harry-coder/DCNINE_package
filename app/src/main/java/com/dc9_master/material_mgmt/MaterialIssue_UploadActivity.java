...
public class MaterialIssue_UploadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(MaterialIssue_UploadActivity.this);
        sessionManager =new SessionManager(MaterialIssue_UploadActivity.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(MaterialIssue_UploadActivity.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(MaterialIssue_UploadActivity.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(MaterialIssue_UploadActivity.this);
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(MaterialIssue_UploadActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(sessionManager.GET_CURRENT_URL()+"insert_material_store_transfer_issue");
                    ...
                    nameValuePairs.add(new BasicNameValuePair("issue_date", DataHolder_workprogress.getInstance().getStr_recev_date()));
                    nameValuePairs.add(new BasicNameValuePair("issue_noteNo", DataHolder_workprogress.getInstance().getStr_receiving_note_no()));
                    ...
                    Log.e("name value missue", "" + nameValuePairs);
