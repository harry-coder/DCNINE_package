...
public class MaterialReceived_UploadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(MaterialReceived_UploadActivity.this);
        sessionManager =new SessionManager(MaterialReceived_UploadActivity.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(MaterialReceived_UploadActivity.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(MaterialReceived_UploadActivity.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(MaterialReceived_UploadActivity.this);
                    ...
                    sqLiteAdapter.insert_valueLOADING(sessionManager.GET_EMP_ID(),
                            ...
                            DataHolder_workprogress.getInstance().getHhsc_manpower(),
                            DataHolder_workprogress.getInstance().getNetwork_manpower(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(MaterialReceived_UploadActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                try {
                    ...
                    HttpPost httppost = new HttpPost(sessionManager.GET_CURRENT_URL()+"insert_material_store_transfer_received");
                    ...
                    nameValuePairs.add(new BasicNameValuePair("from_district", DataHolder_workprogress.getInstance().getGeographoic_id()));
                    nameValuePairs.add(new BasicNameValuePair("to_district", DataHolder_workprogress.getInstance().getGeographoic_id1()));
                    nameValuePairs.add(new BasicNameValuePair("from_store", DataHolder_workprogress.getInstance().getSubareaone()));
                    nameValuePairs.add(new BasicNameValuePair("to_store", DataHolder_workprogress.getInstance().getSubareaone1()));
                    nameValuePairs.add(new BasicNameValuePair("receiving_date", DataHolder_workprogress.getInstance().getStr_recev_date()));
                    nameValuePairs.add(new BasicNameValuePair("receiving_note", DataHolder_workprogress.getInstance().getStr_receiving_note_no()));
                    nameValuePairs.add(new BasicNameValuePair("store_keeperName", DataHolder_workprogress.getInstance().getStr_storeKeepeName()));
                    nameValuePairs.add(new BasicNameValuePair("item_inputValue", DataHolder_workprogress.getInstance().getStr_item_code1()));
                    ...
                    Log.e("name value received", "" + nameValuePairs);
