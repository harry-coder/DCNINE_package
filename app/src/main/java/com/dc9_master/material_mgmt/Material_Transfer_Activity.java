 ...
 */
public class Material_Transfer_Activity extends Activity {
    Button next_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.store_transfer_issue);
        ...
        new Geographic_Value(Material_Transfer_Activity.this).execute();
        spinner_geographic.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if (position > 0) {
                    new SubAreaOne_Value(Material_Transfer_Activity.this).execute();
                    } else {
        ...
        new Geographic_Value1(Material_Transfer_Activity.this).execute();
        spinner_geographic1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                //   Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                if (position > 0) {
                    new SubAreaOne_Value1(Material_Transfer_Activity.this).execute();
                    } else {
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(spinner_geographic.getSelectedItemPosition() == 0 ||
                    ...
                    final Dialog dialog = new Dialog(Material_Transfer_Activity.this);
                    ...
                    DataHolder_workprogress.getInstance().setStr_issue_note_no(str_insp_date);
                    ...
                    startActivity(new Intent(Material_Transfer_Activity.this, Material_Transfer_Item_Activity.class));
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Material_Transfer_Activity.this);
           ...
           protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Material_Transfer_Activity.this);
            try {
