package com.dc9_master.manpower;
...
public class ManpowerUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(ManpowerUpload.this);
        sessionManager =new SessionManager(ManpowerUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(ManpowerUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(ManpowerUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(ManpowerUpload.this);
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(ManpowerUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("subareatwo", DataHolder_workprogress.getInstance().getSubareaone()));
                    nameValuePairs.add(new BasicNameValuePair("subareathree", DataHolder_workprogress.getInstance().getSubareaone()));
                    nameValuePairs.add(new BasicNameValuePair("hhsc_manpower", DataHolder_workprogress.getInstance().getHhsc_manpower()));
                    nameValuePairs.add(new BasicNameValuePair("network_manpower", DataHolder_workprogress.getInstance().getNetwork_manpower()));
                    nameValuePairs.add(new BasicNameValuePair("auto_number", DataHolder_workprogress.getInstance().getAuto_number()));


                    httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
                    Log.e("name value manpower", "" + nameValuePairs);
