...
import com.dc9_master.safety_check.Safety_Item_Activity;
 ...
 */
public class Manpower_Activity extends Activity {

    EditText ed_service,ed_infra;
    ...
    String geographic_id,geographic_name,
            ...
            subarea_three_code,subarea_three_name,str_service,str_infra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manpower);

        sessionManager = new SessionManager(Manpower_Activity.this);
        ...
        ed_infra=(EditText)findViewById(R.id.ed_infra);
        ...
        new Geographic_Value(Manpower_Activity.this).execute();
        spinner_geographic.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //   Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                if (position > 0) {
                    new SubAreaOne_Value(Manpower_Activity.this).execute();
                } else {
        ...
        spinner_subarea_one.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                //  Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                  if (position > 0) {
                    new SubAreaTwo_Value(Manpower_Activity.this).execute();
                    } else {
                    spinner_subarea_two.setVisibility(View.GONE);
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                if (position > 0) {
                    new SubAreaThree_Value(Manpower_Activity.this).execute();
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_service=ed_service.getText().toString();
                str_infra=ed_infra.getText().toString();
                if (spinner_geographic.getSelectedItemPosition() == 0 ||
                    ...
                    final Dialog dialog = new Dialog(Manpower_Activity.this);
                ...
                else
                    {
                        ...
                        DataHolder_workprogress.getInstance().setHhsc_manpower(str_service);
                        DataHolder_workprogress.getInstance().setNetwork_manpower(str_infra);
                        DataHolder_workprogress.getInstance().setAuto_number(auto_number);

                        startActivity(new Intent(Manpower_Activity.this, ManpowerUpload.class));
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Manpower_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Manpower_Activity.this);
            try {
