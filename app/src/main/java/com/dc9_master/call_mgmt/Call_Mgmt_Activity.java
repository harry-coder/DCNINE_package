 ...
 */
public class Call_Mgmt_Activity extends Activity {

    EditText ed_callDEtails;
    ...
    String geographic_project_code, geographic_id,geographic_name,
            ...
            subareathree_two_code,subarea_three_code,subarea_three_name,call_code,call_name,str_callDEtails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.call_mgmt);

        sessionManager = new SessionManager(Call_Mgmt_Activity.this);
        ...
        spinner_call = findViewById(R.id.call_type);
        ed_callDEtails = findViewById(R.id.ed_call_details);
        ...
        new Geographic_Value(Call_Mgmt_Activity.this).execute();
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaOne_Value(Call_Mgmt_Activity.this).execute();
                } else {
        ...
        spinner_subarea_one.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
               ...
               //  Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                  if (position > 0) {
                    new SubAreaTwo_Value(Call_Mgmt_Activity.this).execute();
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaThree_Value(Call_Mgmt_Activity.this).execute();
        ...
        new CallType_Value(Call_Mgmt_Activity.this).execute();
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_callDEtails=ed_callDEtails.getText().toString();
                ...
                if (spinner_geographic.getSelectedItemPosition() == 0 ||
                        ...
                        spinner_call.getSelectedItemPosition() == 0 || TextUtils.isEmpty(str_callDEtails)) {

                    final Dialog dialog = new Dialog(Call_Mgmt_Activity.this);
                ...
                else
                    {
                        ...
                        DataHolder_workprogress.getInstance().setStrCallType(call_code);
                        DataHolder_workprogress.getInstance().setStrCallDetails(str_callDEtails);
                       ...
                       // startActivity(new Intent(Site_Inspection_Activity.this, Site_Inspection_Item.class));
                        startActivity(new Intent(Call_Mgmt_Activity.this, CallMgmtUpload.class));
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Call_Mgmt_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Call_Mgmt_Activity.this);
            try {
    ...
    public class CallType_Value extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                call_cursor = sqLiteAdapter.select_nature_all();
                call_code_list.clear();
                call_name_list.clear();
                if(call_cursor!=null && call_cursor.moveToFirst()){
                    call_code_list.add("Select Call Type");
                    call_name_list.add("Select Call Type");
