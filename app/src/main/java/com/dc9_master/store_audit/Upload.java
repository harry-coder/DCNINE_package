        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    sqLiteAdapter.insert_valueSTORE(sessionManager.GET_EMP_ID(),
                            sessionManager.GET_PROJECT(),
                            DataHolder_workprogress.getInstance().getStr_insp_date(),
                            DataHolder_workprogress.getInstance().getStr_store_id(),
                            DataHolder_workprogress.getInstance().getStrpmaName(),
                            DataHolder_workprogress.getInstance().getStr_storeKeepeName(),
                            DataHolder_workprogress.getInstance().getStr_item_code(),
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("store_id", DataHolder_workprogress.getInstance().getStr_store_id()));
                    nameValuePairs.add(new BasicNameValuePair("pma_name", DataHolder_workprogress.getInstance().getStrpmaName()));
                    nameValuePairs.add(new BasicNameValuePair("storeKeeperName", DataHolder_workprogress.getInstance().getStr_storeKeepeName()));
                    nameValuePairs.add(new BasicNameValuePair("book_qty", DataHolder_workprogress.getInstance().getStr_item_code()));
                    nameValuePairs.add(new BasicNameValuePair("physical_qty", DataHolder_workprogress.getInstance().getStr_item_code1()));
                    ...
                    Log.e("name value audit", "" + nameValuePairs);
