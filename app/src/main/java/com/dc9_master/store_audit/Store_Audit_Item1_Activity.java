 ...
 */
public class Store_Audit_Item1_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.field_transfer);
        ...
        new Item_Value(Store_Audit_Item1_Activity.this).execute();
        ...
        btn_remark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Store_Audit_Item1_Activity.this, Remark_Activity.class);
                startActivity(i);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Store_Audit_Item1_Activity.this, Upload.class);
                startActivity(i);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
    ...
    public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Store_Audit_Item1_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Store_Audit_Item1_Activity.this);
            try {
