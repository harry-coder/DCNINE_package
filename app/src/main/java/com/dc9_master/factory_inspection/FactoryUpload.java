...
public class FactoryUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(FactoryUpload.this);
        sessionManager =new SessionManager(FactoryUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(FactoryUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(FactoryUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(FactoryUpload.this);
                    ...
                    sqLiteAdapter.insert_valueFACT(sessionManager.GET_EMP_ID(),
                            sessionManager.GET_PROJECT(),
                            DataHolder_workprogress.getInstance().getStr_insp_date(),
                            DataHolder_workprogress.getInstance().getStr_po_no(),
                            DataHolder_workprogress.getInstance().getStr_di_no(),
                            DataHolder_workprogress.getInstance().getStr_factorylocation(),
                            DataHolder_workprogress.getInstance().getStr_vendor_rspName(),
                            DataHolder_workprogress.getInstance().getStr_fact_rsp(),
                            DataHolder_workprogress.getInstance().getStr_item_code1(),
    ...
    public class SendToServer extends AsyncTask<String, String, String>
    {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(FactoryUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(sessionManager.GET_CURRENT_URL()+"insert_factory_upload");
                    ...
                    nameValuePairs.add(new BasicNameValuePair("audit_date", DataHolder_workprogress.getInstance().getStr_insp_date()));
                    nameValuePairs.add(new BasicNameValuePair("po_no", DataHolder_workprogress.getInstance().getStr_po_no()));
                    nameValuePairs.add(new BasicNameValuePair("di_no", DataHolder_workprogress.getInstance().getStr_di_no()));
                    nameValuePairs.add(new BasicNameValuePair("factory_location", DataHolder_workprogress.getInstance().getStr_factorylocation()));
                    nameValuePairs.add(new BasicNameValuePair("vendor_rspName", DataHolder_workprogress.getInstance().getStr_vendor_rspName()));
                    nameValuePairs.add(new BasicNameValuePair("factory_rspName", DataHolder_workprogress.getInstance().getStr_fact_rsp()));
                    nameValuePairs.add(new BasicNameValuePair("item_value", DataHolder_workprogress.getInstance().getStr_item_code1()));
                    ...
                    Log.e("name value fact", "" + nameValuePairs);
