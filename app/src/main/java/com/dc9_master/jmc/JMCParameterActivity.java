 ...
 */
public class JMCParameterActivity extends Activity {
    private static JMCParameterActivity sActivity;
    public static JMCParameterActivity getsActivity(){return sActivity;}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jmc_item);
        ...
        //-------------for Pole Activity------------------//
        new Item_Value(JMCParameterActivity.this).execute();
       //-------------for Pole Remark-----------------//
        remark_btn=(Button)findViewById(R.id.btn_remark);
        remark_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(JMCParameterActivity.this, Remark_Activity.class);
                startActivity(i);
       ...
       //--- Back Button
        ...
        btn_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(checkitem)) {
                    final Dialog dialog = new Dialog(JMCParameterActivity.this);
        ...
        finish_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    Intent i = new Intent(JMCParameterActivity.this, JMCUpload.class);
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(JMCParameterActivity.this);
            ...
            Intent i = new Intent(JMCParameterActivity.this, Camera1_Activity.class);
            startActivity(i);
            overridePendingTransition(R.anim.right_in, R.anim.left_out);
    ...
    public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(JMCParameterActivity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(JMCParameterActivity.this);
            try {
