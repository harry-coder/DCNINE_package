 ...
 */
public class JMC_Item_Activity extends Activity {


    Button back_btn, pending_btn,od_cancel,od_punchin,btn_next;
    LinearLayout pop_od;
    EditText ed_remark;
    String str_remark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(JMC_Item_Activity.this, Upload_Activity.class);
                startActivity(i);
