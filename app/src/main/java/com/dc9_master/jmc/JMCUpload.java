...
public class JMCUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(JMCUpload.this);
        sessionManager =new SessionManager(JMCUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(JMCUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(JMCUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(JMCUpload.this);
                    ...
                    sqLiteAdapter.insert_valueJMC(sessionManager.GET_EMP_ID(),
                            ...
                            DataHolder_workprogress.getInstance().getStrcontractorName(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(JMCUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                try {
                    ...
                    //HttpPost httppost = new HttpPost("http://monitorpm.feedbackinfra.com/dcnine_bajaj_demo/embc_app/insert_jmc");
                    ...
                    nameValuePairs.add(new BasicNameValuePair("contractorName", DataHolder_workprogress.getInstance().getStrcontractorName()));
                    nameValuePairs.add(new BasicNameValuePair("item_qty", DataHolder_workprogress.getInstance().getStr_checkbox_inputValue()));
                    ...
                    Log.e("name value jmc", "" + nameValuePairs);
