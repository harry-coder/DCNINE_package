 ...
 */
public class RecvInspectionChecklist_Activity extends Activity {
    private static RecvInspectionChecklist_Activity sActivity;

    public static RecvInspectionChecklist_Activity getsActivity(){return sActivity;}
    Button remark_btn,camera_btn,btn_next,finish_btn;
    Button back_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recvinspection_checkbox);
        ...
        connectionDetector=new ConnectionDetector(RecvInspectionChecklist_Activity.this);
        sqLiteAdapterw= new SQLiteAdapterWorkprogress(RecvInspectionChecklist_Activity.this);
        ...
        //-------------for Pole Activity------------------//
        new Item_Value(RecvInspectionChecklist_Activity.this).execute();
        sessionManager = new SessionManager(RecvInspectionChecklist_Activity.this);
        ...
        remark_btn=(Button)findViewById(R.id.imageButton6);
          remark_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(RecvInspectionChecklist_Activity.this, SiteInspectionRemark_Activity.class);
                startActivity(i);
       ...
       /* camera_btn=(Button)findViewById(R.id.imageButton5);
        camera_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(RecvInspectionChecklist_Activity.this, Camera_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
...
*/
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getItem_id())) {

                    final Dialog dialog = new Dialog(RecvInspectionChecklist_Activity.this);
                   ...
                   /* sqLiteAdapterw.openToRead();
                    ...
                    dialogButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            startActivity(new Intent(RecvInspectionChecklist_Activity.this, Material_Recv_Item_Activity.class));
                            }
                    });

                    dialog.show();*/

                   /* startActivity(new Intent(SurveyNextActivity.this, SurveyNextActivity.class));
                    Toast.makeText(SurveyNextActivity.this, "Sending Data To Server", Toast.LENGTH_SHORT).show();*/
                   }
            }
        });
        ...
        finish_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone()) ) {
                    ...
                    dialog.setContentView(R.layout.custom);
                    TextView text = (TextView) dialog.findViewById(R.id.text);
                    text.setText("Due to Force clsoe app District, Store  data entry fill again");
                    Button dialogButton = (Button) dialog.findViewById(R.id.dialogButtonOK);
                    // if button is clicked, close the custom dialog
                    dialogButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    /* permit_id= sessionManager.GET_EMP_ID();
                     ...
                     Intent i = new Intent(RecvInspectionChecklist_Activity.this, MaterialUpload.class);
                      startActivity(i);
                      overridePendingTransition(R.anim.right_in, R.anim.left_out);
                   }
                }
    ...
    public void onBackPressed() {
      ...
      public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(RecvInspectionChecklist_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(RecvInspectionChecklist_Activity.this);
            try {
                ...
                item_cursor=sqLiteAdapter.select_item_parameter_all(Integer.parseInt(DataHolder_workprogress.getInstance().getItem_id()));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
               ...
               /* final AreaDataAdapter adapter= new AreaDataAdapter(getApplicationContext(), item_name_list,item_code_list);
                ...
                final AreaDataSIAdapter adapter= new AreaDataSIAdapter(RecvInspectionChecklist_Activity.this, item_name_list,item_code_list);
                listView.setAdapter(adapter);
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(RecvInspectionChecklist_Activity.this);
