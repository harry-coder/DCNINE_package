...
public class SafetyUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(SafetyUpload.this);
        sessionManager =new SessionManager(SafetyUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(SafetyUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(SafetyUpload.this);
                    ...
                    sqLiteAdapter.insert_valueSA(sessionManager.GET_EMP_ID(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(SafetyUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                try {
                    ...
                    Log.e("name value safety", "" + nameValuePairs);
