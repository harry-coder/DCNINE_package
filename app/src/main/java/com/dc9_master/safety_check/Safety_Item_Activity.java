 ...
 */
public class Safety_Item_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.safety_inspection_item);
        //GridView
        ...
        new ChooseItemValue(Safety_Item_Activity.this).execute();
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View v, int position, long arg3) {
               ...
               // Intent i = new Intent(SiteInspection_Item_Activity.this, Site_Inspection_Parameters.class);
                Intent i = new Intent(Safety_Item_Activity.this, SafetyChecklist_Activity.class);
                startActivity(i);
    ...
    public class ChooseItemValue extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(Safety_Item_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Safety_Item_Activity.this);
            try {
                ...
                item_cursor=sqLiteAdapter.select_safety_item_all();
