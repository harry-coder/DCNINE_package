...
import com.dc9_master.sor.Site_Inspection_PassRework;
 ...
 */
public class SafetyChecklist_Activity extends Activity {
    private static SafetyChecklist_Activity sActivity;

    public static SafetyChecklist_Activity getsActivity(){return sActivity;}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.safetyinspection_checkbox);
        ...
        //-------------for Pole Activity------------------//
        new Item_Value(SafetyChecklist_Activity.this).execute();
        sessionManager = new SessionManager(SafetyChecklist_Activity.this);
        //-------------for Pole Remark-----------------//
        remark_btn=(Button)findViewById(R.id.imageButton6);
        remark_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SafetyChecklist_Activity.this, SiteInspectionRemark_Activity.class);
                startActivity(i);
        ...
        camera_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mLocation != null) {
                    startActivity(new Intent(SafetyChecklist_Activity.this, Camera_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
...
//                        op=DataHolder_SiteInspection.getInstance().getSelectedStrings();
                ...
                if (TextUtils.isEmpty(DataHolder_workprogress.getInstance().getGeographoic_id()) || TextUtils.isEmpty(DataHolder_workprogress.getInstance().getSubareaone()) ||
                    ...
                    final Dialog dialog = new Dialog(SafetyChecklist_Activity.this);
                   ...
                   // Intent i = new Intent(SiteInspectionChecklist_Activity.this, SiteInspectionUpload.class);
                    Intent i = new Intent(SafetyChecklist_Activity.this, Safety_PassRework.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                }
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(SafetyChecklist_Activity.this);
    ...
    public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(SafetyChecklist_Activity.this);
          ...
          protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(SafetyChecklist_Activity.this);
            try {
               ...
               item_cursor=sqLiteAdapter.select_safety_item_parameter_all(Integer.parseInt(DataHolder_workprogress.getInstance().getItem_id()));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
               ...
               /* final AreaDataAdapter adapter= new AreaDataAdapter(getApplicationContext(), item_name_list,item_code_list);
                ...
                final AreaDataSIAdapter adapter= new AreaDataSIAdapter(SafetyChecklist_Activity.this, item_name_list,item_code_list);
                listView.setAdapter(adapter);
