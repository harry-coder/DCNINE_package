 ...
 */
public class CameraMultiPic_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_multipic);

        sessionManager = new SessionManager(CameraMultiPic_Activity.this);
        ...
        camera_btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(CameraMultiPic_Activity.this, Camera1_Activity.class));
        ...
        camera_btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(CameraMultiPic_Activity.this, Camera2_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        camera_btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(CameraMultiPic_Activity.this, Camera3_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        camera_btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(CameraMultiPic_Activity.this, Camera4_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        camera_btn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(CameraMultiPic_Activity.this, Camera5_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
    ...
    public void ShowAlertagain1() {
        if (!isLocationServiceEnabled()) {
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(CameraMultiPic_Activity.this);
