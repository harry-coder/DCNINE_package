...
public class IssueUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(IssueUpload.this);
        sessionManager =new SessionManager(IssueUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(IssueUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(IssueUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(IssueUpload.this);
                    ...
                    sqLiteAdapter.insert_valueISSUE(sessionManager.GET_EMP_ID(),
                            ...
                            DataHolder_workprogress.getInstance().getStr_issueType(),
                            DataHolder_workprogress.getInstance().getStr_otherissue(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(IssueUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("issueType", DataHolder_workprogress.getInstance().getStr_issueType()));
                    nameValuePairs.add(new BasicNameValuePair("otherIssue", DataHolder_workprogress.getInstance().getStr_otherissue()));
                    ...
                    Log.e("name value issue", "" + nameValuePairs);
