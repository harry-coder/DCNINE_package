 ...
 */
public class Issues_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.issue_raised);
        sessionManager = new SessionManager(Issues_Activity.this);
        ...
        spinner_call = (Spinner) findViewById(R.id.issue_typeid);
        ed_other = (EditText) findViewById(R.id.ed_other_issue);
        issue_btn=(Button) findViewById(R.id.btn_issue);
        ...
        call_name_list=new ArrayList<String>();
        call_code_list=new ArrayList<String>();

        new Geographic_Value(Issues_Activity.this).execute();
        spinner_geographic.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //   Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                if (position > 0) {
                    new SubAreaOne_Value(Issues_Activity.this).execute();
                } else {
        ...
        spinner_subarea_one.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                //  Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                  if (position > 0) {
                    new SubAreaTwo_Value(Issues_Activity.this).execute();
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaThree_Value(Issues_Activity.this).execute();
        ...
        new CallType_Value(Issues_Activity.this).execute();
        spinner_call.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view,
                                       int position, long id) {
                // TODO Auto-generated method stub
                call_code = call_code_list.get(position).toString();
                call_name = call_name_list.get(position).toString();
            }
        ...
        issue_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Issues_Activity.this, SiteInspectionRemark_Activity.class);
                startActivity(i);
        ...
        camera_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocation != null) {
                    startActivity(new Intent(Issues_Activity.this, CameraMultiPicAll_Activity.class));
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                    } else {
                    ShowAlertagain();
                }
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_other=ed_other.getText().toString();
                ...
                if (spinner_geographic.getSelectedItemPosition() == 0 ||
                    ...
                    final Dialog dialog = new Dialog(Issues_Activity.this);
                    ...
                    else
                    {
                        ...
                        DataHolder_workprogress.getInstance().setStr_issueType(call_code);
                        DataHolder_workprogress.getInstance().setStr_otherissue(str_other);
                        DataHolder_workprogress.getInstance().setAuto_number(auto_number);
                        startActivity(new Intent(Issues_Activity.this, IssueUpload.class));
                        overridePendingTransition(R.anim.right_in, R.anim.left_out);
                     }
                }
         });
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(Issues_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(Issues_Activity.this);
            try {
    ...
    //---------------------  Call Type inspecton --------------------------------------//
    public class CallType_Value extends AsyncTask<String, String, String> {
        ProgressDialog pd;Context _context;
        CallType_Value(Context ctx) {_context=ctx;}
        @Override
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                call_cursor = sqLiteAdapter.select_issue_all();
                call_code_list.clear();
                call_name_list.clear();
                if(call_cursor!=null && call_cursor.moveToFirst()){
                    call_code_list.add("Select Issue Type");
                    call_name_list.add("Select Issue Type");

                    do {
                        String call_code=call_cursor.getString(1);
                        String call_name=call_cursor.getString(2);
                       /* Log.e("code",code);
                        Log.e("name",name);*/
                        call_code_list.add(call_code);
        ...
        protected void onPostExecute(String result) {
            ...
            pd.dismiss();
            try {
                call_adapter = new ArrayAdapter<String>(
                        getApplicationContext(), R.layout.custom_spinner, R.id.textView1, call_name_list);
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Issues_Activity.this);
