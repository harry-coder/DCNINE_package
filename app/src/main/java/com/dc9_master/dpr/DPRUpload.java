...
public class DPRUpload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(DPRUpload.this);
        sessionManager =new SessionManager(DPRUpload.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(DPRUpload.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(DPRUpload.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(DPRUpload.this);
                    ...
                    sqLiteAdapter.insert_valueDPR(sessionManager.GET_EMP_ID(),
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(DPRUpload.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                try {
                    ...
                    HttpPost httppost = new HttpPost(sessionManager.GET_CURRENT_URL()+"insert_dpr");
                    ...
                    nameValuePairs.add(new BasicNameValuePair("inputvalue", DataHolder_workprogress.getInstance().getStr_checkbox_inputValue()));
                    ...
                    Log.e("name value dpr", "" + nameValuePairs);
