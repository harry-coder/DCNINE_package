 ...
 */
public class DPR_ItemActivity extends Activity {
    private static DPR_ItemActivity sActivity;
    public static DPR_ItemActivity getsActivity(){return sActivity;}
    Button remark_btn,finish_btn,btn_camera;
    Button back_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //-------------for Pole Activity------------------//
        new Item_Value(DPR_ItemActivity.this).execute();
       //-------------for Pole Remark-----------------//
        remark_btn=(Button)findViewById(R.id.btn_remark);
        remark_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DPR_ItemActivity.this, SiteInspectionRemark_Activity.class);
                startActivity(i);
        ...
        btn_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(checkitem)) {
                    final Dialog dialog = new Dialog(DPR_ItemActivity.this);
        ...
        finish_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                  try{
                        ...
                        meMap=DataHolder_workprogress.getInstance().getMeMap();
                     ...
                     Intent i = new Intent(DPR_ItemActivity.this, DPRUpload.class);
                     startActivity(i);
                     overridePendingTransition(R.anim.right_in, R.anim.left_out);
                   }
        });
    ...
    public void ShowAlertagain() {
        if (!isLocationServiceEnabled()) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(DPR_ItemActivity.this);
            ...
            Intent i = new Intent(DPR_ItemActivity.this, CameraMultiPicAll_Activity.class);
            startActivity(i);
            overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
    }
    ...
    public class Item_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(DPR_ItemActivity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(DPR_ItemActivity.this);
            try {
