 ...
 */
public class DPR_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(DPR_Activity.this);
        ...
        new Geographic_Value(DPR_Activity.this).execute();
        spinner_geographic.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //   Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                if (position > 0) {
                    new SubAreaOne_Value(DPR_Activity.this).execute();
                } else {
        ...
        spinner_subarea_one.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
               ...
               //  Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                  if (position > 0) {
                    new SubAreaTwo_Value(DPR_Activity.this).execute();
...
//                Toast.makeText(getApplicationContext(),""+subdivision_code,Toast.LENGTH_LONG).show();
                ...
                if (position > 0) {
                    new SubAreaThree_Value(DPR_Activity.this).execute();
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinner_geographic.getSelectedItemPosition() == 0 ||
                    ...
                    final Dialog dialog = new Dialog(DPR_Activity.this);
                ...
                else
                    {
                        ...
                        startActivity(new Intent(DPR_Activity.this, DPR_ItemActivity.class));
    ...
    public class Geographic_Value extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(DPR_Activity.this);
        ...
        protected String doInBackground(String... params) {
            // TODO Auto-generated method stub
            sqLiteAdapter=new SQLiteAdapter1(DPR_Activity.this);
            try {
