 ...
 */
public class DPR_Item_Activity extends Activity {


    Button back_btn, pending_btn,od_cancel,od_punchin,btn_uprep,btn_pics, btn_next;
    LinearLayout pop_od;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DPR_Item_Activity.this, Upload_Activity.class);
                startActivity(i);
