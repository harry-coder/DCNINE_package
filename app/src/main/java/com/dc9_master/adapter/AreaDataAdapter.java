...
public class AreaDataAdapter extends ArrayAdapter<String> {
    ...
    public AreaDataAdapter(Context context, List<String> offersAreaList, List<String> offersAreaCodeList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row==null) {
            ...
            holder.checkBox3 = (CheckBox)row.findViewById(R.id.na);
            holder.textInListView = (TextView)row.findViewById(R.id.textView1);
            holder.inputBTN= (Button)row.findViewById(R.id.inputButton);
//            holder.checkBox.setTypeface(fontFace);
        ...
        holder.checkBox3.setFocusable(false);
        holder.checkBox3.setChecked(positionArray3.get(position));
        ...
        holder.checkBox2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    DataHolder_SiteInspection.getInstance().setSelectedItems2(selectedItems2);
        ...
        holder.checkBox3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    DataHolder_SiteInspection.getInstance().setSelectedItems_na(selectedItems3);
                    System.out.println("ffff" + position);
                } else {
                    //change state of concern item in 'positionArray' array to 'True'
                    positionArray.set(position, false);
