...
public class JMCListviewAdapter extends BaseAdapter {
    ...
    public ArrayList<String> selectedItems_value1 = new ArrayList<String>();
    HashMap<String, String> meMap1=new HashMap<String, String>();

    LayoutInflater mInflater;
    public JMCListviewAdapter(Context context, List<String> list, List<String> offersAreaCodeList, List elist){
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.listview_with_inputcheckboxjmc, null);
            //convertView = mInflater.inflate(R.layout.jmc_paralistview, null);
