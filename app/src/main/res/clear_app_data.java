package com.dc9_master.define_ring;
...
public class clear_app_data extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector=new ConnectionDetector(clear_app_data.this);
        sessionManager =new SessionManager(clear_app_data.this);
        sqLiteAdapter= new SQLiteAdapterWorkprogress(clear_app_data.this);
        sqLiteAdaptersummary= new SQLiteAdapter1(clear_app_data.this);
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectionDetector.isConnectingToInternet()) {
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(clear_app_data.this);
                    ...
                    dialogButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            startActivity(new Intent(clear_app_data.this, Home_Activity.class));
                            finish();
                            overridePendingTransition(R.anim.right_in, R.anim.left_out);
                    ...
                    sqLiteAdapter.insert_valueRING(sessionManager.GET_EMP_ID(),
                            ...
                            DataHolder_workprogress.getInstance().getStr_other_gp(),
                    ...
                    //----------for daily survey summary count --------------------------//
                     /*  sqLiteAdaptersummary.openToRead();
                    sqLiteAdaptersummary.openToWrite();
                    sqLiteAdaptersummary.insert_summary(DataHolder_workprogress.getInstance().getAuto_number(),"","","","",str_timestamp);
                    sqLiteAdaptersummary.close();*/
...
//            Log.e("from", "sendtoserver");
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
           /* pd = new ProgressDialog(SurveyUpload.this);
            pd.setMessage("Please wait...");
            pd.setCancelable(false);
            pd.show();*/

            Toast.makeText(clear_app_data.this, "Sending Data To Server", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(clear_app_data.this, Home_Activity.class));
            overridePendingTransition(R.anim.right_in, R.anim.left_out);
        }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(sessionManager.GET_CURRENT_URL()+"insert_define_ring");
                    ...
                    nameValuePairs.add(new BasicNameValuePair("other_gp", DataHolder_workprogress.getInstance().getStr_other_gp()));

                    nameValuePairs.add(new BasicNameValuePair("latt", DataHolder_workprogress.getInstance().getCamera_lat()));
                    nameValuePairs.add(new BasicNameValuePair("longg", DataHolder_workprogress.getInstance().getCamera_long()));
                    nameValuePairs.add(new BasicNameValuePair("time", DataHolder_workprogress.getInstance().getCamera_time()));
        ...
        protected void onPostExecute(String result) {
           ...
           /* startActivity(new Intent(SurveyUpload.this, Home_Activity.class));
            finish();
            overridePendingTransition(R.anim.right_in, R.anim.left_out);*/
               ...
               // Log.e("response",""+response);
                ...
                if (response != null && response.equals("1")) {
                  ...
                  //  Toast.makeText(, response.toString(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(clear_app_data.this, "Data Sent Successfully", Toast.LENGTH_SHORT).show();
                    // custom dialog
                   /* final Dialog dialog = new Dialog(SurveyUpload.this);
                    dialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
                    dialog.getWindow().setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL);
                    dialog.setContentView(R.layout.custom);
